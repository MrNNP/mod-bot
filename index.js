...
bot.on('message', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!msg.content.startsWith(prefix)) return [3 /*break*/, 3];
                ...
                return [3 /*break*/, 3];
            case 1: return [4 /*yield*/, src_1["default"].commands.user.setup(msg).then(function (guildObj) { return src_1["default"].db.setDBitem(guildObj.id, guildObj); })];
            case 2:
                _b.sent();
